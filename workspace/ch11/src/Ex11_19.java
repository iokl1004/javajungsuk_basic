...
public class Ex11_19 {
	...
	public static void main(String[] args) {
		...
		swap(list, 0, 2);	//첫번째와 세번째는 교환(swap)
		System.out.println(list);
		...
		Enumeration e = enumeration(list);	//자주 쓰이는 메서드는 아님!
		ArrayList list2 = list(e); //자주 쓰이는 메서드는 아님!
		
		System.out.println("list2=" + list2); //자주 쓰이는 메서드는 아님!
	}
